...
<table id="ws-table">
    ...
    <tr>
        <td id="ws-td-toolbar">
            ...
            <i id="ws-home-button" class="sw sw-home i24 button" onclick="app.activeDoc.tree.selectRoot()"></i>
            <i id="ws-refresh-button" class="sw sw-refresh i24 button" onclick="app.activeDoc.tree.refresh()"></i>
            <div class="vline"></div>
            <i id="ws-collapse-button" class="sw sw-collapse i24 button" onclick="app.activeDoc.tree.collapseAll()"></i>
            <i id="ws-expand-button" class="sw sw-expand i24 button" onclick="app.activeDoc.tree.expandAll()"></i>
            <div class="vline"></div>
